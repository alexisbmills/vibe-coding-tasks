...
- Name: Task List >> should toggle task completion
- Location: C:\Users\alexi\www\react-task-ai\e2e\task-list.spec.ts:48:3
...
Call log:
  - waiting for getByRole('checkbox', { name: /Completion Toggle Task 1747368558383/i })
    - locator resolved to <input value="" type="checkbox" aria-checked="false" class="chakra-checkbox__input" aria-label="Mark task "Completion Toggle Task 1747368558383" as complete"/>
  - attempting click action
    ...
    at C:\Users\alexi\www\react-task-ai\e2e\task-list.spec.ts:53:20
```
...
- list "Task list":
  - 'listitem "Task: Completion Toggle Task 1747368558383"':
    - checkbox "Mark task \"Completion Toggle Task 1747368558383\" as complete"
    - paragraph: Completion Toggle Task 1747368558383
    - button "Archive task": Archive
    - link "Edit task":
      - /url: /task/1df7f70f-1419-4196-9d62-eb27ff628784
      - text: Edit
