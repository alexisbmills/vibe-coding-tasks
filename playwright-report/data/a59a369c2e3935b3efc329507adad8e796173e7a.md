...
- Name: Task Edit >> should support keyboard shortcuts in edit form
- Location: C:\Users\alexi\www\react-task-ai\e2e\task-edit.spec.ts:43:3
...
Call log:
  ...
  - waiting for getByLabel(/task name/i)
    8 × locator resolved to <input name="name" required="" id="field-:rl:" aria-required="true" placeholder="Enter task name" class="chakra-input css-dn3ifq" value="Edit Keyboard 1747368533625"/>
      - unexpected value "inactive"

    at C:\Users\alexi\www\react-task-ai\e2e\task-edit.spec.ts:48:49
```
...
- form "Edit task form":
  - group:
    - text: Task Name
    - textbox "Task Name": Edit Keyboard 1747368533625
  - group:
    - text: Notes
    - textbox "Notes"
