...
- Name: Task List >> should have accessible roles and labels
- Location: C:\Users\alexi\www\react-task-ai\e2e\task-list.spec.ts:82:3
...
Call log:
  ...
  - waiting for getByRole('main')
    ...
    at C:\Users\alexi\www\react-task-ai\e2e\task-list.spec.ts:84:42
```
