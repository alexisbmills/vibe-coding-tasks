...
- Name: Task List >> should filter tasks by archived and non-archived
- Location: C:\Users\alexi\www\react-task-ai\e2e\task-list.spec.ts:59:3
...
Call log:
  - waiting for getByRole('button', { name: /active tasks/i })

    at C:\Users\alexi\www\react-task-ai\e2e\task-list.spec.ts:64:63
```
...
- paragraph: No tasks yet. Create your first task to get started!
