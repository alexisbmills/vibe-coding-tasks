...
- Name: Task Management >> should complete and uncomplete a task
- Location: C:\Users\alexi\www\react-task-ai\e2e\task-management.spec.ts:13:3
...
Call log:
  - waiting for getByRole('checkbox', { name: /Management Complete 1747368585808/i })
    - locator resolved to <input value="" type="checkbox" aria-checked="false" class="chakra-checkbox__input" aria-label="Mark task "Management Complete 1747368585808" as complete"/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="chakra-card__body css-1idwstw">…</div> intercepts pointer events
    ...
    at C:\Users\alexi\www\react-task-ai\e2e\task-management.spec.ts:17:20
```
...
- list "Task list":
  - 'listitem "Task: Management Complete 1747368585808"':
    - checkbox "Mark task \"Management Complete 1747368585808\" as complete"
    - paragraph: Management Complete 1747368585808
    - button "Archive task": Archive
    - link "Edit task":
      - /url: /task/0966d86c-c366-4b82-b0fa-a3478df9966e
      - text: Edit
